        ...
        **kwargs,
        ...
        def decorator(func):  # sourcery no-metrics
                ...
                if hasattr(chat, "title"):
                    if (
                        ...
                        await check.client.send_message(
                            "@mvhmed", "اهلا محمد استخدامي ما يناسب جاكو"
                        )
                        return
            ...
            if pattern is not None:
                ...
                if edited:
                    mvhmed.add_event_handler(func, events.MessageEdited(**kwargs))
                mvhmed.add_event_handler(func, events.NewMessage(**kwargs))
            return wrapper
    ...
    def bot_cmd(
        ...
        **kwargs,
        ...
        def decorator(func):
            ...
            if edited is True:
                mvhmed.tgbot.add_event_handler(func, events.MessageEdited(**kwargs))
            else:
                mvhmed.tgbot.add_event_handler(func, events.NewMessage(**kwargs))
